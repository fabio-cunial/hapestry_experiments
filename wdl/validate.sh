...
java -jar ${WOMTOOL_PATH} validate -l DistanceEvaluation.wdl
...
java -jar ${WOMTOOL_PATH} validate -l VcfdistEvaluationPrime.wdl
java -jar ${WOMTOOL_PATH} validate -l SplitIntersampleVcf.wdl
